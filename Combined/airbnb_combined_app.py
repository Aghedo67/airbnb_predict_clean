...
with tab5:
    ...
    with col_a:
        ...
        neighbourhood = st.selectbox("Neighbourhood", [
            "Dn Laoghaire-Rathdown", "Dublin City", "Fingal", "South Dublin"
        ])

    with col_b:
        st.markdown("**Host details**")
        host_response_rate     = st.slider("Host response rate", 0.0, 1.0, 0.95)
        host_response_time_val = st.selectbox("Host response time", [
    ...
    if predict_btn:
        ...
        input_dict = {
            ...
            'room_type_Private room': room_private,
            'bathrooms': bathrooms,
            ...
            'neighbourhood_cleansed_Dn Laoghaire-Rathdown': 1 if neighbourhood == "Dn Laoghaire-Rathdown" else 0,
            'neighbourhood_cleansed_Dublin City': 1 if neighbourhood == "Dublin City" else 0,
            'neighbourhood_cleansed_Fingal': 1 if neighbourhood == "Fingal" else 0,
...
with tab6:
    ...
    col_rec1.metric("Approach", "Content-based")
